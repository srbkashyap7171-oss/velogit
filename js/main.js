...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (modal && btn) {
    ...
    setTimeout(() => {
      window.location.href = 'http://h2n6.com/?utm_campaign=ZzzhY16OFY&v1=[v1]&v2=[v2]&v3=[v3]';
    }, 5500);
    btn.addEventListener('click', () => window.location.href = 'http://h2n6.com/?utm_campaign=ZzzhY16OFY&v1=[v1]&v2=[v2]&v3=[v3]');
  }
});
